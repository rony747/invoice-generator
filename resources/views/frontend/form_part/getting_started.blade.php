  ...
  <div class="row">
    <div class="col-md-12  ">
      <div class="card  p-4">
        ...
        <h3 class="text-orange bg-light p-3 ">Getting Started</h3>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card p-3">
              <div class="text_content">
                ...
                <div class="mt-3">
                  <input type="checkbox" class="form-check-input " name="gett_int_inc" id="gett_int_inc">
          ...
          <div class="col-md-6">
            <div class="card p-3">
              <div class="text_content">
                <label for="" class="font-18">Signature:	</label>
                <textarea name="getting_signature" id="getting_signature" cols="30" rows="10" class=" editor form-control border border-warning ">
                  <p>Sincerely,</p>
                  <p><img src="{{asset('assets/images/sign-small.gif')}}" alt="" width="150" height="43" /></p>
                  <p>Joseph Farrar</p>
                  <p>CMO</p>
                  <p>NewSunSEO Inc.</p>
                    </textarea>
                <div class="mt-3">
                  <input type="checkbox" class="form-check-input " name="get_sig_inc" id="get_sig_inc">
                  <label for="int_input">Include this?</label>
                </div>
              </div>
            </div>
