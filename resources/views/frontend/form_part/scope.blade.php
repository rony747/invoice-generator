  ...
  <div class="row">
    <div class="col-md-12  ">
      <div class="card  p-4">
        ...
        <h3 class="text-orange bg-light p-3 ">Scope of Work - Firm</h3>
            ...
            <div class="card p-3">
              <div class="text_content">
                ...
                <textarea name="" id="" cols="30" rows="10" class=" editor form-control border border-warning ">
                      ...
                      <li>Provide photos / images if possible (We can help with this & have access to stock photos for approx. $15 - $20 each photo</li>
